      ...
      <Grid2 container spacing={2} height={"100vh"} backgroundColor="white">
        ...
        <Grid2 container className="w-[48%] mt-10 justify-center">
          <Grid2 className="w-[70%]">
            ...
            <Box className="my-8">
              <Typography variant="h6" color="black" className="mt-10 mb-3">Nome do titular do cartão</Typography>
              <TextField
                fullWidth
                variant="outlined" />

              <Typography variant="h6" color="black" className="mt-10 mb-3">Dados do cartão</Typography>
              <TextField
                fullWidth
